...
window["Api"]["addReservation"] = function (userInfoId,seatId,reservationBeginTime,reservationEndTime,notArrive){
    ...
    var dataS = {
        ...
        "reservationEndTime":reservationEndTime,
        "notArrive":notArrive,
        "reservationRule":userInfo.reservationLengthRule,
 ...
 */
window["Api"]["addReservationDay"] = function (userInfoId,seatId,reservationBeginTime,reservationEndTime,notArrive){
    var arg = "" ;
    notArrive = notArrive != null ? notArrive : "1";
    seatId = seatId ? seatId : $("#SeatDataID").val();
    var userInfo = g.userInfo();
    ...
    var Authorization = userInfo.token;
    var dataS = {
        "url":g.ContextPath + "reservation/addReservationBychooseDay",
        //"url":g.researchPath + "reservation/addReservationBychooseDay",
        "userInfoId":userInfoId,
        "seatId":seatId,
        "reservationBeginTime":reservationBeginTime,
        "reservationEndTime":reservationEndTime,
 ...
 * @returns {string}
 */
window["Api"]["selectReservationByUserDay"] = function (){
    var arg = "" ;
    var userInfo = g.userInfo();
    var dataS = {
        "url":g.ContextPath + "reservation/selectReservationByUserDay",
        "userInfoId":userInfo.userInfoId,
        "Authorization":userInfo.token
    };
 ...
 * @returns {string}
 */
window["Api"]["getRecommendReservationTimeConflict"] = function (seatId,reservationBeginTime,reservationEndTime){
    var arg = "" ;
    var userInfo = g.userInfo();
    var dataS = {
        "url":g.ContextPath + "seat/getRecommendReservationTimeConflict",
        "userInfoId":userInfo.userInfoId,
        "seatId":seatId,
        "reservationBeginTime":reservationBeginTime,
        "reservationEndTime":reservationEndTime,
 ...
 * @returns {string}
 */
window["Api"]["extendSeatTimeDay"] = function (reservationId,reservationEndTime,reservationBeginTime){
    var arg = "" ;
    var userInfo = g.userInfo();
    var dataS = {
        "url":g.ContextPath + "reservation/extendSeatTimeDay",
        "userInfoId":userInfo.userInfoId,
        "reservationId":reservationId,
        "reservationEndTime":reservationEndTime,
        "reservationBeginTime":reservationBeginTime,
