...
window["Api"]["Schools"] = function(){
    ...
    $.ajax({
        ...
        url		:	g.researchPath + "school/selectSchool",
        async	:	false,
...
window["Api"]["login"] = function (userNum,userPwd,schoolNum){
    ...
    $.ajax({
        ...
        url		:	g.researchPath + "userInfo/login",
        async	:	false,
        success	:	function(res){
            if(res){
                arg = res;
...
window["Api"]["selectCampusAndBuildingInfomation"] = function (){
    ...
    $.ajax({
        ...
        url		:	g.researchPath + "selectInfo/selectCampusAndBuildingInfomation",
        async	:	false,
        success	:	function(res){
            if(res){
                arg = res;
...
window["Api"]["selectEachClassroom"] = function (buildingId,reservationBeginTime,reservationEndTime){
    ...
    $.ajax({
        ...
        url		:	g.researchPath + "selectInfo/selectEachClassroom_TotalSeatsAndRemainSeats",
        async	:	false,
        success	:	function(res){
            if(res){
                arg = res;
...
window["Api"]["selectBuildingContainResearchRoom"] = function (token,userId){
    ...
    $.ajax({
        ...
        url		:	g.researchPath + "selectInfo/selectBuildingContainResearchRoom",
       // Authorization:token,
        async	:	false,
...
window["Api"]["selectResearchRoom"] = function (buildingId,userId){
    ...
    $.ajax({
       ...
       // url		:	g.ContextPath + "researchRoom/selectResearchRoom",
        url		:	g.researchPath + "researchRoom/selectResearchRoom",
        async	:	false,
        success	:	function(res){
            if(res){
                arg = res;
...
window["Api"]["SeatsInfo"] = function (classroomId,reservationBeginTime,reservationEndTime){
    ...
    $.ajax({
       ...
       // url		:	g.ContextPath + "selectInfo/selectEachClassroom_SeatsInfo",
        url		:	g.researchPath + "selectInfo/selectEachClassroom_SeatsInfo",
        async	:	false,
        success	:	function(res){
            if(res){
                arg = res;
...
window["Api"]["addReservation"] = function (userInfoId,seatId,reservationBeginTime,reservationEndTime,notArrive){
    ...
    var dataS = {
        ...
        "url":g.researchPath + "reservation/addReservationBychoose",
...
window["Api"]["selectReservationByUser"] = function (){
    ...
    var dataS = {
        ...
        "url":g.researchPath + "reservation/selectReservationByUser",
